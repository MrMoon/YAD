...
def CommentOutClass(source: str  = typer.Argument(..., help="The path of the .cpp or .h file the user wants comment out class to work on."),
...
def CommentOutFunction(source: str  = typer.Argument(..., help="The path of the .cpp or .h file the user wants comment out class to work on."),
